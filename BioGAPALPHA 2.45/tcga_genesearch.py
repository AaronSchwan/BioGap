...
def geneSearch(entry,outliers,dataS,STAGES,AGES,SEXES,RACES):
    ...
    if(dataS == "Lung Squamous Cell Carcinoma (TCGA, Provisional)"):
        ...
        with open("/home/aaron/Desktop/BioGAPALPHA 2.45/Data Sources/Data Lung Squamous Cell Carcinoma (TCGA, Provisional)/PDATALUSC.csv",'r') as file:
    ...
    if(dataS == "Lung Adenocarcinoma (TCGA, Provisional)"):
        ...
        with open("/home/aaron/Desktop/BioGAPALPHA 2.45/Data Sources/Data Lung Adenocarcinoma (TCGA, Provisional)/PDATALUAD.csv",'r') as file:
            data = file.read().split('\n');
            file.close();
    ...
    while(x<len(rawDataT_)):
        
        #print(RaceDataT_[x])
        if(int(StageDataT_[x]) in STAGES and RaceDataT_[x] in RACES and SexDataT_[x] in SEXES and lowage<=AgeDataT_[x]<=highage):
...
#geneSearch('RASAL2',"Exclude Outliers",'Lung Squamous Cell Carcinoma (TCGA, Provisional)',[1,2,3,4],[0,10000000],[1,0],['white'])
