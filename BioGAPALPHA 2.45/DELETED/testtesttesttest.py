...
# a tk.DrawingArea
canvas = FigureCanvasTkAgg(f, master=None)
canvas.show()
...
# a tk.DrawingArea
canvas2 = FigureCanvasTkAgg(f2, master=None)
canvas2.show()
...
def on_key_event(event):
    print('you pressed %s' % event.key)
    key_press_handler(event, canvas2, toolbar2)

canvas2.mpl_connect('key_press_event', on_key_event)
