...
##        menu.add_cascade(label="Graph Options", menu=graphs)
        ...
        def cellline_search_ncbi():
            ...
            if(x>=1):
                ...
                info = str(info).replace('',';').replace('{',',').replace('}','').replace('"','').replace("'",'').replace('(','').replace(")",'')
        ...
        def search_prob():
            ...
            if(varc1.get() == 1):
                ...
                urls.insert(breaker,str(data[5]).replace('',';').replace('{',',').replace('}','').replace('"','').replace("'",'').replace('(','').replace(")",'').replace(" ",''))
